...
import impl.mysql.MySqlProvider;
import impl.mysql.MySqlAdapter;
import example.models.Customer;
import java.util.List;

public class MySqlConsoleDemo {
    public static void main(String[] args) {

        String uri = "YOUR_DB_URI";
        MySqlProvider provider = new MySqlProvider();
        provider.connect(uri);
        MySqlAdapter<Customer> customerAdapter = provider.getAdapter(Customer.class);
